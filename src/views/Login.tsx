  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (username === 'admin' && password === 'admin') {
        ...
        setError('Credenciais inválidas. Use "admin" para usuário e senha.');
        setIsLoading(false);
      }
    }, 1500);
  };
      ...
      >
        <div className="glass border border-kve-border rounded-2xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-2xl font-black text-white tracking-tighter text-center">GAROS</h1>
            <p className="text-slate-500 text-[10px] font-mono uppercase tracking-[0.3em] mt-2">Diskless & Terminal Control v1.2.4</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            
            {/* Operational Scope Banner */}
            <div className="bg-slate-950/60 p-3 border border-kve-border rounded-xl text-center space-y-1">
              <div className="flex items-center justify-center gap-2 text-xs font-bold text-kve-accent uppercase tracking-wider">
                <Server size={14} />
                <span>GAROS SERVER</span>
              </div>
              <p className="text-[9px] text-slate-500 leading-normal">
                🖥️ Gerenciamento local de sistemas diskless, boot PXE e terminais de rede.
              </p>
            </div>
