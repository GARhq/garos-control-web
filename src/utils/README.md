...
## 📌 Visão Geral
Módulo integrante da arquitetura do repositório GAROS no caminho `garos-control-web/src/utils`.
...
- `__tests__/`: **[Módulo]** — Subsistema e arquivos de organização do módulo `__tests__`.
- `theme.ts`: **[Componente/Módulo TS/JS]** — Implementação TypeScript/React exportando exports `GarosPreferences, defaultPreferences, getSavedPreferences`.
